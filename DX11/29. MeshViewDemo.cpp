...
bool MeshViewDemo::Init()
{
	...
	_treeModel = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/tree.m3d", L"../Resources/Textures/");
	_baseModel = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/base.m3d", L"../Resources/Textures/");
	_stairsModel = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/stairs.m3d", L"../Resources/Textures/");
	_pillar1Model = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/pillar1.m3d", L"../Resources/Textures/");
	_pillar2Model = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/pillar2.m3d", L"../Resources/Textures/");
	_pillar3Model = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/pillar5.m3d", L"../Resources/Textures/");
	_pillar4Model = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/pillar6.m3d", L"../Resources/Textures/");
	_rockModel = make_shared<BasicModel>(_device, _texMgr, "../Resources/Models/rock.m3d", L"../Resources/Textures/");
