...
NormalMapSkinnedEffect::NormalMapSkinnedEffect(ComPtr<ID3D11Device> device, const std::wstring& filename)
	: Effect(device, filename)
{
	Light1Tech = _fx->GetTechniqueByName("Light1");
	Light2Tech = _fx->GetTechniqueByName("Light2");
	...
	Light1SkinnedTech = _fx->GetTechniqueByName("Light1Skinned");
	Light2SkinnedTech = _fx->GetTechniqueByName("Light2Skinned");
	Light3SkinnedTech = _fx->GetTechniqueByName("Light3Skinned");

	Light0TexSkinnedTech = _fx->GetTechniqueByName("Light0TexSkinned");
	Light1TexSkinnedTech = _fx->GetTechniqueByName("Light1TexSkinned");
	Light2TexSkinnedTech = _fx->GetTechniqueByName("Light2TexSkinned");
	Light3TexSkinnedTech = _fx->GetTechniqueByName("Light3TexSkinned");

	Light0TexAlphaClipSkinnedTech = _fx->GetTechniqueByName("Light0TexAlphaClipSkinned");
	Light1TexAlphaClipSkinnedTech = _fx->GetTechniqueByName("Light1TexAlphaClipSkinned");
	Light2TexAlphaClipSkinnedTech = _fx->GetTechniqueByName("Light2TexAlphaClipSkinned");
	Light3TexAlphaClipSkinnedTech = _fx->GetTechniqueByName("Light3TexAlphaClipSkinned");

	Light1FogSkinnedTech = _fx->GetTechniqueByName("Light1FogSkinned");
	Light2FogSkinnedTech = _fx->GetTechniqueByName("Light2FogSkinned");
	Light3FogSkinnedTech = _fx->GetTechniqueByName("Light3FogSkinned");

	Light0TexFogSkinnedTech = _fx->GetTechniqueByName("Light0TexFogSkinned");
	Light1TexFogSkinnedTech = _fx->GetTechniqueByName("Light1TexFogSkinned");
	Light2TexFogSkinnedTech = _fx->GetTechniqueByName("Light2TexFogSkinned");
	Light3TexFogSkinnedTech = _fx->GetTechniqueByName("Light3TexFogSkinned");

	Light0TexAlphaClipFogSkinnedTech = _fx->GetTechniqueByName("Light0TexAlphaClipFogSkinned");
	Light1TexAlphaClipFogSkinnedTech = _fx->GetTechniqueByName("Light1TexAlphaClipFogSkinned");
	Light2TexAlphaClipFogSkinnedTech = _fx->GetTechniqueByName("Light2TexAlphaClipFogSkinned");
	Light3TexAlphaClipFogSkinnedTech = _fx->GetTechniqueByName("Light3TexAlphaClipFogSkinned");

	Light1ReflectSkinnedTech = _fx->GetTechniqueByName("Light1ReflectSkinned");
	Light2ReflectSkinnedTech = _fx->GetTechniqueByName("Light2ReflectSkinned");
	Light3ReflectSkinnedTech = _fx->GetTechniqueByName("Light3ReflectSkinned");

	Light0TexReflectSkinnedTech = _fx->GetTechniqueByName("Light0TexReflectSkinned");
	Light1TexReflectSkinnedTech = _fx->GetTechniqueByName("Light1TexReflectSkinned");
	Light2TexReflectSkinnedTech = _fx->GetTechniqueByName("Light2TexReflectSkinned");
	Light3TexReflectSkinnedTech = _fx->GetTechniqueByName("Light3TexReflectSkinned");

	Light0TexAlphaClipReflectSkinnedTech = _fx->GetTechniqueByName("Light0TexAlphaClipReflectSkinned");
	Light1TexAlphaClipReflectSkinnedTech = _fx->GetTechniqueByName("Light1TexAlphaClipReflectSkinned");
	Light2TexAlphaClipReflectSkinnedTech = _fx->GetTechniqueByName("Light2TexAlphaClipReflectSkinned");
	Light3TexAlphaClipReflectSkinnedTech = _fx->GetTechniqueByName("Light3TexAlphaClipReflectSkinned");

	Light1FogReflectSkinnedTech = _fx->GetTechniqueByName("Light1FogReflectSkinned");
	Light2FogReflectSkinnedTech = _fx->GetTechniqueByName("Light2FogReflectSkinned");
	Light3FogReflectSkinnedTech = _fx->GetTechniqueByName("Light3FogReflectSkinned");

	Light0TexFogReflectSkinnedTech = _fx->GetTechniqueByName("Light0TexFogReflectSkinned");
	Light1TexFogReflectSkinnedTech = _fx->GetTechniqueByName("Light1TexFogReflectSkinned");
	Light2TexFogReflectSkinnedTech = _fx->GetTechniqueByName("Light2TexFogReflectSkinned");
	Light3TexFogReflectSkinnedTech = _fx->GetTechniqueByName("Light3TexFogReflectSkinned");

	Light0TexAlphaClipFogReflectSkinnedTech = _fx->GetTechniqueByName("Light0TexAlphaClipFogReflectSkinned");
	Light1TexAlphaClipFogReflectSkinnedTech = _fx->GetTechniqueByName("Light1TexAlphaClipFogReflectSkinned");
	Light2TexAlphaClipFogReflectSkinnedTech = _fx->GetTechniqueByName("Light2TexAlphaClipFogReflectSkinned");
	Light3TexAlphaClipFogReflectSkinnedTech = _fx->GetTechniqueByName("Light3TexAlphaClipFogReflectSkinned");
...
NormalMapSkinnedEffect::~NormalMapSkinnedEffect()
{
}
...
shared_ptr<NormalMapSkinnedEffect> Effects::NormalMapSkinnedFX;
...
void Effects::InitAll(ComPtr<ID3D11Device> device, const std::wstring& filename)
{
	...
	NormalMapSkinnedFX = make_shared<NormalMapSkinnedEffect>(device, L"../Shaders/31. NormalMapSkinned.fx");
}
