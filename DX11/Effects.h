...
class NormalMapSkinnedEffect : public Effect
{
public:
	NormalMapSkinnedEffect(ComPtr<ID3D11Device> device, const std::wstring& filename);
	~NormalMapSkinnedEffect();
...
public:
	...
	static shared_ptr<NormalMapSkinnedEffect> NormalMapSkinnedFX;
};